            ...
            >
              ...
              <div>
                ...
                <ul>
                  {meal
                    .match(
                      /Ingredients:\s*([\s\S]*?)(?=Preparation:|Nutritional breakdown:|Meal Idea|$)/
                    )?.[1]
                  ...
                  {/* Trim and display each ingredient */}
                </ul>
              </div>
              <div>
                <h4>Preparation:</h4>
                <p>
                  {
                    meal.match(
                      /Preparation:\s*([\s\S]*?)(?=Nutritional breakdown:|Meal Idea|$)/
                    )?.[1]
                  }
                </p>{" "}
                {/* Preparation */}
              ...
              <div>
                ...
                <p>
                  {
                    meal.match(
                      /Nutritional breakdown:\s*([\s\S]*?)(?=Meal Idea|$)/
                    )?.[1]
                  }
                </p>{" "}
                {/* Nutritional info */}
